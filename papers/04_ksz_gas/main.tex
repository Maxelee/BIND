...
\begin{figure}[t]
\centering
\includegraphics[width=0.95\textwidth]{figs/fig01_lightcone_design_hmf.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.95\textwidth]{figs/fig02_methods_cap_schematic.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.62\textwidth]{figs/fig03_fgas_erosita.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.95\textwidth]{figs/fig04_response_fan.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.68\textwidth]{figs/fig05_cap_ratio_confront.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.55\textwidth]{figs/fig06_money_forecast.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.95\textwidth]{figs/fig07_tsz_pressure.png}
\caption{\textbf{(a)} $y$-CAP amplitude for all 256 Sobol nodes (light blue),
the 49 kSZ-CAP-consistent nodes (orange), and the \bind\ fiducial run at the
corrected DESI-LRG lensing mass $\log\Mhalo=13.18\,\Msun/h$ \citep{sailer24},
against the ACT$\times$DESI LRG data; the shaded band shows the $\pm0.1$-dex
...
\begin{figure}[t]
\centering
\includegraphics[width=0.95\textwidth]{figs/fig08_latent_2d.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.95\textwidth]{figs/fig09_field_1d_latent.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.95\textwidth]{figs/fig10_field_desY3_act.png}
...
gas-excess tension identified per-halo in Section~\ref{sec:results3}. (The
panel's own super-title rounds this to a stale ``$\sim1.5$--$2\times$''
estimate from an earlier reduction pass; the precise, current values are the
