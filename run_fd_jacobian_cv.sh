#!/bin/bash
#SBATCH --job-name=fd_jac_cv
#SBATCH --output=/mnt/home/mlee1/ceph/logs/fd_jac_cv_%A_%a.out
#SBATCH --error=/mnt/home/mlee1/ceph/logs/fd_jac_cv_%A_%a.err
#SBATCH --time=6:00:00
...
SHARD_PREFIX=${SHARD_PREFIX:-proj6_cv_fd_scatter_shard}
...
#       --output     "$OUT_DIR/proj6_cv_fd_scatter_fm_two_head.npz"
