#!/bin/bash
#SBATCH --job-name=bind_tauplane
#SBATCH --output=/mnt/home/mlee1/ceph/logs/bind_lc_tauplane_%A_%a.out
#SBATCH --error=/mnt/home/mlee1/ceph/logs/bind_lc_tauplane_%A_%a.err
...
srun python -u -m bind.cli.paint_tauplane \
...
echo "=== tau-planes done for snap ${SNAP3} (task ${IDX}). ==="
