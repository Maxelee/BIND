...
def _maybe_attach_thermo_metrics(
    summary: dict, prepared: dict, generated_halos: np.ndarray, predict_thermo: bool,
) -> None:
    """Add per-channel thermo dex bias/scatter to the summary, if available.
